						...
						return (
							...
							>
								<div className='flex items-start gap-6'>
									...
									<div>
										...
										<div className='flex items-center mt-2'>
											...
											<p className='px-2 sm:px-3 sm:py-1 border border-gray-300 bg-slate-100 mx-2'>
												{item.size}
											</p>
										</div>
									</div>
								...
								<input
									...
									className='border border-gray-300 rounded-md max-w-10 sm:max-w-20 px-1 sm:px-2 py-1'
									type='number'
									min={1}
					...
					<div className='w-full sm:w-[450px]'>
						...
						<div className='w-full text-end'>
							<button
								...
								className={`bg-black text-white text-sm my-8 px-8 py-3 ${isCartEmpty ? 'opacity-50 cursor-not-allowed' : ''
									}`}
